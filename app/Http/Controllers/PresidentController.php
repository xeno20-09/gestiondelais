...
class PresidentController extends Controller
{
    ...
    {
        return view('Recours.President.home');
    }
    public function getlisterecours_a_affectes()
    {
        ...
        return view('Recours.President.listerecoursa_affectes', compact('recours'));
    }
    ...
    public function getformrecours_a_affecte(Request $request)
    {
        ...
        return view('Recours.President.form_recoursa_affecte', compact('recours'));
    }
