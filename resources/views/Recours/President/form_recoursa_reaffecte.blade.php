            ...
            <div class="card-body">
                ...
                <form class="form-sample" method="POST" action="{{ route('pca.post_form_affecte') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Section:Ancienne
                                    valeur:{{ $recours->section->nom_section }}</label>
                                <div class="col-sm-9">
                                    <select class="form-control" onchange="getrefractoremember()" id="section"
                                        name="section">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Greffier:Ancienne
                                    valeur:{{ $recours->partie->greffier->nom }} {{ $recours->partie->greffier->prenoms }}
                                </label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Conseiller:Ancienne
                                    valeur:{{ $recours->partie->conseiller->nom }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Auditeur:Ancienne
                                    valeur:{{ $recours->partie->auditeur->nom }} {{ $recours->partie->auditeur->prenoms }}
                                </label>
                                <div class="col-sm-9">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <button class="btn btn-primary">Reaffecter</button>
                        </div>
                    </div>
                </form>
            </div>
