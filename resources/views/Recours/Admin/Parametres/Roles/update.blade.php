                    ...
                    <form class="form-sample" method="POST" action="{{ route('roles.update', $role->id) }}">
                        ...
                        <div class="row">
                            <div class="col-xl-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title text-black">Liste des permissions</h4>
                                                ...
                                                @foreach ($permissions as $value)
                                                    <li>
                                                        <div class="form-check">
                                                            ...
                                                            <span class="list-time">Permission ID: {{ $value->id }}</span>
                                                        </div>
                                                    </li>
                                                @endforeach
                                            </ul>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success">Modifier le role</button>
                            </div>
                        </div>
                    </form>
                @endcan
