...
<body class="bg-red-100"
    ...
    <table class="bg-red-100 body" valign="top" role="presentation" border="0" cellpadding="0" cellspacing="0"
        ...
        <tbody>
            <tr>
                <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left" bgcolor="#fff">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                    ...
                                                    <img class="w-16"
                                                        src="https://i.ibb.co/NdS5LD4w/imbenin-removebg-preview.png"
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <p class=""
                                                            ...
                                                            align="left">
                                                            @if ($joursRestants == 0)
                                                                <strong>URGENCE - Délai expirant
                                                                    aujourd'hui</strong><br>
                                                                Nous vous informons que le délai pour l'exécution de la
                                                                mesure d'instruction concernant votre client
                                                                expire aujourd'hui.
                                                            @elseif($joursRestants == 1)
                                                                <strong>Dernier rappel - Délai imminent</strong><br>
                                                                Il ne reste plus que <strong>1 jour</strong> pour
                                                                l'exécution de la mesure d'instruction concernant votre
                                                                client
                                                            @elseif($joursRestants <= 3)
                                                                <strong>Rappel important - Délai approchant</strong><br>
                                                                Il ne reste plus que <strong>{{ $joursRestants }}
                                                                    jours</strong> pour l'exécution de la mesure
                                                                d'instruction concernant votre client
                                                            @else
                                                                <strong>Rappel - Délai en cours</strong><br>
                                                                Il reste <strong>{{ $joursRestants }} jours</strong>
                                                                pour l'exécution de la mesure d'instruction concernant
                                                                votre client
                                                            @endif
                                                        </p>
                                                        ...
                                                        <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 10px 0 0 0;"
                                                            ...
                                                            • Mesure :
                                                            {{ $recours->lastMouvement->instruction->nom }}<br>
                                                            • Initiation :
                                                            {{ \Carbon\Carbon::parse($recours->lastMouvement->date_debut_instruction)->locale('fr_FR')->isoFormat('dddd D MMM Y') }}<br>
                                                            • Échéance :
                                                                    ...
                                                                    <div style="margin-top: 20px; text-align: center;">
                                                                        @if ($joursRestants == 0)
                                                                            <div
                                                                                ...
                                                                                <strong>ACTION REQUISE : Délai expire
                                                                                    aujourd'hui</strong><br>
                                                                        ...
                                                                        @elseif($joursRestants <= 3)
                                                                            <div
                                                                                ...
                                                                                <strong>ATTENTION : Délai
                                                                                    approchant</strong><br>
                                                                                Merci de relayer cette information à
                                                                                votre client.
                                                                            </div>
                                                                        @else
                                                                            <div
