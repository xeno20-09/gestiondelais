...
<body>
    <div class="message">Vous n'êtes pas autorisé.</div>
    <div class="message2">Vous avez tenté d'accéder à une page sans autorisation préalable.</div>
    <div class="container">
        <div class="neon">Oops!</div>
